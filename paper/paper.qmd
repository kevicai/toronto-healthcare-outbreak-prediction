...
The factors influencing outbreak duration can vary significantly depending on the healthcare setting, the causative agent of the illness, and the timing of the outbreak. In nursing homes, for example, the close living conditions, shared spaces, and frequent interactions between residents, staff, and visitors contribute to the spread of infections. In hospitals, the high turnover of patients and healthcare workers, coupled with the need for intensive medical care, can also worsen the problem. Additionally, the characteristics of specific pathogens can influence transmission dynamics and outbreak duration. For instance, the concentration of SARS-CoV-2 in patient secretions peaks approximately 10 days after symptom onset, influencing transmission patterns and the length of outbreaks in healthcare facilities [@sarsOnHealthcare]. Understanding why some outbreaks persist longer than others requires identifying the drivers of these durations. While previous studies have examined factors affecting outbreak durations, more research is needed, especially within the context of Toronto's healthcare system. Toronto, with its large and diverse population, faces unique challenges in managing healthcare-associated outbreaks. This study aims to estimate the factors influencing the duration of infectious disease outbreaks in Toronto healthcare facilities, by examining various factors such as the type of healthcare setting, the causative agent, and the month when the outbreak occurred, 

To better understand the relationships between these factors and outbreak duration, this study employs a Bayesian negative binomial regression model. This statistical model is well-suited to handling count data and predicting the number of days an outbreak lasts. By identifying the drivers of outbreak duration, the study will help inform strategies for improving outbreak preparedness and response. These findings are important for optimizing resource allocation, ensuring that healthcare facilities are well equipped to handle outbreaks, and improving response efforts.
