#### Preamble ####
# Purpose: Tests the structure and validity of the simulated outbreak dataset.
# Author: Kevin Cai
# Date: Dec 1, 2024
...
df = pd.read_csv(os.path.join(script_dir, "../data/00-simulated_data/simulated_data.csv"))
...
pytest.main(["scripts/01-test_simulated_data.py"])
